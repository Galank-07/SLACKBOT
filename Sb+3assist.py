...
def bot(op):
    try:
        ...
        if op.type == 25:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "ub4ec190dc4450579d841fba7968311b4":
                    if "join:" in msg.text:
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
                ...
                msg.text = None
                cl.sendMessage(msg)
            elif msg.text in ["愛のプレゼント","Itachi gift"]:
                msg.contentType = 9
                ...
                msg.text = None
                ki.sendMessage(msg)
            elif msg.text in ["愛のプレゼント","Obito gift"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '6'}
                msg.text = None
                kk.sendMessage(msg)
            elif msg.text in ["愛のプレゼント","Daidara gift"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '3'}
...
#--------------------------------------------------------
            ...
            elif msg.text in ["Add confirm","自動追加問候語確認"]:
                if wait["lang"] == "JP":
...
#-----------------------------------------------------------   
	        elif "Muach " in msg.text:
              #if msg.from_ in admin:
                    ulti0 = msg.text.replace("Muach ","")
                    ulti1 = ulti0.lstrip()
                    ulti2 = ulti1.replace("@","")
                    ulti3 = ulti2.rstrip()
                    _name = ulti3
